...
export const pincodeConstants ={
  GET_ALL_PINCODES_REQUEST: ' GET_ALL_PINCODES_REQUEST',
  GET_ALL_PINCODES_SUCCESS: ' GET_ALL_PINCODES_SUCCESS',
  GET_ALL_PINCODES_FAILURE: ' GET_ALL_PINCODES_FAILURE',

  DELETE_PINCODE_BY_ID_REQUEST: "DELETE_PINCODE_BY_ID_REQUEST",
  DELETE_PINCODE_BY_ID_SUCCESS: "DELETE_PINCODE_BY_ID_SUCCESS",
  DELETE_PINCODE_BY_ID_FAILURE: "DELETE_PINCODE_BY_ID_FAILURE",
