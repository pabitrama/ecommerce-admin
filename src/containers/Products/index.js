...
const Products = (props) => {
  ...
  const [sizeLquantity, setSizeLQuantity] = useState("");
  ...
  const submitProductForm = () => {
    ...
    formData.append("L_quantity", sizeLquantity);
    ...
    // }
      ...
      return;
    } else if (sizeLquantity === "") {
      alert("quantity of L size is required");
      return;
    } 
      ...
      <Modal
        ...
        <div style={{ display: "flex" }}>
          ...
          <Input
            ...
            value={sizeLquantity}
            placeholder={`Quantity`}
            onChange={(e) => setSizeLQuantity(e.target.value)}
          />
        </div>
 {/*
        <div style={{ display: "flex" }}>
      ...
      <Modal
        ...
        <Row>
          <Col md="6">
            ...
            <p className="value">{`${productDetails.sizeSquantity}+${productDetails.sizeMquantity}+${productDetails.sizeLquantity}`}</p>
          </Col>
          <Col md="6">
